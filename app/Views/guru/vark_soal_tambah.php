...
<div class="row justify-content-center">
    <div class="col-md-10">
        <div class="card card-shadow">
            <div class="card-body">
                <h4 class="fw-bold mb-4"><i class="fas fa-plus-circle text-success me-2"></i>Tambah Soal VARK</h4>
                ...
                <form action="<?= base_url('guru/vark/soal/simpan') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="mb-3">
                                ...
                                <textarea name="teks_soal" class="form-control" rows="2" required><?= old('teks_soal') ?></textarea>
                            </div>
                        </div>
                    </div>
